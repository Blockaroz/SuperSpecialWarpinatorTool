...
namespace SuperSpecialWarpinatorTool.Content.Items
{
    ...
    public class SuperSpecialWarpinatorHandsOff : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            Texture2D texture = AssetDirectory.Textures_Player.WarpinatorHandsOff;
    ...
    public class SuperSpecialWarpinatorTank : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            DrawData item = new DrawData(backpackTexture, vec5, backpackTexture.Frame(), drawInfo.colorArmorBody, drawInfo.drawPlayer.bodyRotation, backpackTexture.Size() * 0.5f, 1f, drawInfo.playerEffect);
